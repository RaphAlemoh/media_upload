...
<form class="w-full max-w-lg pt-10 pb-5" action="{{ route('store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3 mb-6 md:mb-0">
        ...
        <input name="name" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white form-control @error('name') border-red-500 @enderror" id="grid-video-name" type="text" placeholder="Video Name" required>
      </div>
    </div>
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full px-3 mb-6 md:mb-0">
          ...
          <input type="file" name="file" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white form-control @error('file') border-red-500 @enderror" id="grid-video-fiile" type="text" placeholder="Upload a video" required>
        </div>
      </div>
